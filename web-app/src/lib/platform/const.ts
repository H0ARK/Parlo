...
export const PlatformFeatures: Record<PlatformFeature, boolean> = {
  ...
  // Default model providers (OpenAI, Anthropic, etc.) - disabled for web-only Parlo builds
  ...
  // Web-specific automatic model selection from Parlo provider - enabled for web only
